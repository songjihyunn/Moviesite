...
<body id="bd" onload="getTime()">
    ...
    <input type="hidden" name="code" value="<%=code%>">    
        <table width="1500" border="0">
            ...
            <tr>
                <td width="150px;"></td>
                <td colspan="5"><textarea name="comment" id="comment" style="margin-left: 98px;" placeholder="내용을 입력하세요"></textarea></td>
            </tr>
            <tr>
            	<td width="150px;"></td>
					<td height=28 style="font-weight: bold">첨부
					<input type="file" name="file1" style="margin-left: 60px;">
				</td>
			</tr>
            <tr>
                <td width="150px;"></td>
